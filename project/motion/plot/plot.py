...
if __name__ == '__main__':
    # raising foot
    points_set_1 = np.array([[0, 7.5, 36], [0, 7.5, 37], [-8, 7.5, 37], [-12, 7.5, 37.5], [-20, 7.5, 43.5]])
    t_points_1 = np.arange(0, 1, 0.05)
    curve_set_1 = Bezier.Curve(t_points_1, points_set_1)
    # save_data('test.csv', curve_set_1)

    # kicking
    points_set_2 = np.array([[-20, 7.5, 43.5], [-10, 7.5, 38], [20, 7.5, 38], [40, 7.5, 40.5]])
    t_points_2 = np.arange(0, 1, 0.1)
