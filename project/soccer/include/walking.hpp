...
class WalkingRobot {
    public:
		...
		static WalkingRobot* GetInstance(){return m_UniqueInstance;}
		...
		double Get_M_Z_MOVE_AMPLITUDE() { return m_Z_Move_Amplitude; }
    ...
    private:
        ...
        static WalkingRobot* m_UniqueInstance;

		webots::Robot *mRobot;
        int mBasicTimeStep;

		webots::Motor* mMotors[DGM_NMOTORS];
		double joint_value[DGM_NMOTORS];
